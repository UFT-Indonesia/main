...
namespace Erp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926081617_AddHolidays")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Core.Aggregates.Attendance.AttendanceLogNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AttendanceLogNotes", (string)null);
                });
            ...
            modelBuilder.Entity("Erp.Core.Aggregates.Attendance.Holiday", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Erp.Core.Aggregates.Employees.EmployeeAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Erp.Core.Aggregates.Attendance.AttendanceLogNote", b =>
                {
                    b.HasOne("Erp.Core.Aggregates.Attendance.AttendanceLog", null)
                        .WithMany("Notes")
                    ...
                    b.OwnsMany("Erp.Core.Aggregates.Employees.EmployeeLeaveQuota", "LeaveQuotas", b1 =>
                        {
                            ...
                            b1.Property<decimal>("EntitledDays")
            ...
            modelBuilder.Entity("Erp.Core.Aggregates.Employees.EmployeeAuditLog", b =>
                {
                    b.HasOne("Erp.Core.Aggregates.Employees.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
